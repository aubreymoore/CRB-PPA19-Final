...
\begin{table}[h]
	...
	\begin{tabular}{l}
		...
		2020 CRB-G Action Group Annual Meeting, virtual meeting conducted as a Zoom webinar) \cite{mooreVideoRecordingCRBG2020}\\
		March 2021 (March) \cite{mooreVideoRecordingCRBG2021}\\
		December 2021 \\
		\bottomrule
	\end{tabular}
